...
/****** Object:  Database [schoolapp]    Script Date: 7/9/2022 09:52:31 ******/
CREATE DATABASE [schoolapp]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'schoolapp', FILENAME = N'C:\Users\marce\schoolapp.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'schoolapp_log', FILENAME = N'C:\Users\marce\schoolapp_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [schoolapp] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [schoolapp] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [schoolapp] SET READ_COMMITTED_SNAPSHOT OFF 
GO
